...
def evaluate_on_test_set(pipe, tracker, test_dataloader, experiment_name, use_autocast=False, fid_reference_images=None):
    """
    Args:
        use_autocast:         True only for QLoRA.
        fid_reference_images: If provided, FID is computed against these images
                              (generated by full fine-tune) instead of real test
                              images. This avoids penalizing models for domain
                              shift vs real images. None = use real test images
                              (only for original_baseline and full_finetune itself).
    """
